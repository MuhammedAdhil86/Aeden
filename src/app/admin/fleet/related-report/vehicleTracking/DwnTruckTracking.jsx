...
function DwnTruckTracking({data}) {
  const handleDownload = () => {
      ...
      utils.book_append_sheet(workbook, worksheet, "Vehicle Tracking");
  
      // Generate file name with current date (e.g., fleet_expense_2025-05-19.xlsx)
      const today = format(new Date(), "yyyy-MM-dd");
      const fileName = `Vehicle_Tracking_${today}.xlsx`;
...
export default DwnTruckTracking