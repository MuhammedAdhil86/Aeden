// components/DriverDetailsDialog.jsx
...
const DriverDetailsDialog = ({ open, onOpenChange, driver, loading }) => {
  const documents = [
    {
      name: "aadhar.pdf",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white text-black max-w-[700px]">
        {loading ? (
            ...
            <div className="border-b flex gap-x-5 pb-3">
              ...
              {(() => {
                const statusColors = {
                  ...
                  "Expired - License": "bg-red-100 text-red-700",
                };

                const colorClasses =
                  statusColors[driver.status] || "bg-neutral-200 text-black";
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-[12px] ml-2 font-medium">{driver.status}</p>
                  </div>
                );
              })()}
            </div>
            <div className="border-b grid grid-cols-3 gap-y-10 py-5">
              <div>
              ...
              <div>
                <p className="text-[10px] font-medium text-gray-600">Date of Birth</p>
                <p className="text-black font-medium text-xs pt-1">
              ...
              <div>
                <p className="text-[10px] font-medium text-gray-600">Aadhar Number</p>
                <p className="text-black font-medium text-xs pt-1">
              ...
              <div>
                <p className="text-[10px] font-medium text-gray-600">License Number</p>
                <p className="text-black font-medium text-xs pt-1">
                  {driver.license_number}
                </p>
              </div>
              <div>
                <p className="text-[10px] font-medium text-gray-600">License Expiry</p>
                <p className="text-black font-medium text-xs pt-1">
