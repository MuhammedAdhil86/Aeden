...
import { fetchassetManagement, fetchFleetExpense } from "@/service/report";
        ...
        const tripsArray = response
          ? response.map((data) => ({
              ...
              last_mnts_date: data.last_updated_maintenance
                ? format(
                    new Date(data.last_updated_maintenance),
                    "MMM dd, yyyy"
                  )
                : "N/A",
    ...
    <div>
      ...
      <div className="pt-5 px-5">
        <div className="w-full flex gap-x-5 items-center">
          <p className="text-black font-medium pt-1">Asset Management</p>
                ...
                table.getRowModel().rows.map((row) => (
                  <TableRow
                    ...
                    onClick={(e) => {
                      ...
                      router.push(
                        `/admin/asset/detail?id=${row.original.id}`
                      );
                    }}
                  >
