...
import { createPort, createCountry, fetchCountry } from "@/service/procurements";
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] bg-white text-black">
        ...
        <form
          onSubmit={handleCountrySubmit(onCountrySubmit)}
          className="space-y-4"
        >
          <div>
...
// PortInfo Component
function PortInfo({ control, ports, setPorts, setValue, errors, countries, setCountries, register }) {
